          ...
          <div style={{ background:"rgba(18,14,32,0.95)", border:"1px solid rgba(100,70,200,0.35)", borderRadius:"24px", padding:"40px", backdropFilter:"blur(20px)", boxShadow:"0 24px 80px rgba(80,40,180,0.2)" }}>
            ...
            <div style={{ textAlign:"center", marginBottom:"28px" }}>
              <img
                ...
                alt="OneSpace Icon"
                style={{ height:"72px", width:"auto", display:"block", margin:"0 auto 10px", objectFit:"contain", filter:"drop-shadow(0 0 18px rgba(140,80,255,0.55))" }}
              />
              <img
                src="/onespace-text.png"
                alt="OneSpace"
                style={{ height:"28px", width:"auto", display:"block", margin:"0 auto 14px", objectFit:"contain", filter:"drop-shadow(0 0 10px rgba(140,80,255,0.4))" }}
              />
