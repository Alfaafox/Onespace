      ...
      <div style={{
        ...
        <div style={{ position:"relative", zIndex:10 }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:"16px" }}>
            {[{icon:"🛡️",title:"Secure",desc:"Enterprise-grade security"},{icon:"👥",title:"Collaborative",desc:"Real-time team collaboration"},{icon:"☁️",title:"Accessible",desc:"Access from any device"}].map(f => (
              <div key={f.title}>
            ...
            <div style={{ textAlign:"center", marginBottom:"28px" }}>
              <img
                ...
                style={{
                  ...
                  display: "block",
                  margin: "0 auto 4px",
                  filter: "invert(1) hue-rotate(180deg) drop-shadow(0 0 12px rgba(120,60,220,0.8))",
                  mixBlendMode: "screen",
                }}
              />
              <img
                ...
                style={{
                  ...
                  display: "block",
                  margin: "0 auto 14px",
                  filter: "invert(1) hue-rotate(180deg) drop-shadow(0 0 8px rgba(120,60,220,0.5))",
                  mixBlendMode: "screen",
                }}
              />
